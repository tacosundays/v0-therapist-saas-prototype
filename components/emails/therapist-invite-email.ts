...
export function renderTherapistInviteEmail({ inviterName, practiceName, inviteLink }: TherapistInviteEmailProps) {
  ...
  const subject = `${safeInviterName} invited you to join ${safePracticeName} on SessionSteps`

  const text = [
    `You have been invited to join ${safePracticeName} on SessionSteps.`,
    "",
            ...
            <tr>
              <td style="padding:12px 32px 4px;">
                ...
                <p style="font-size:16px;line-height:1.6;margin:0 0 14px;color:#344054;">
                  ${safeInviterName} invited you to join their Group Practice workspace in SessionSteps.
                </p>
