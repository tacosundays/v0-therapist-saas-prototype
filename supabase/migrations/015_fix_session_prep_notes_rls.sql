...
ALTER TABLE public.session_prep_notes
...
CREATE INDEX IF NOT EXISTS idx_session_prep_notes_client_updated_at
ON public.session_prep_notes(client_id, updated_at DESC);
...
DROP POLICY IF EXISTS "Therapists can manage own session prep notes"
ON public.session_prep_notes;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.session_prep_notes TO authenticated;
